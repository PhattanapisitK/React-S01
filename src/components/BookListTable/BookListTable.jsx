...
function BookListTable({ books }) {
    const view = async (id) => {
        await axios.get(`https://node57538-phattanapisitk.proen.app.ruk-com.cloud/books/${id}`)
    ...
    const deleted = async (book) => {
        await axios.delete(`https://node57538-phattanapisitk.proen.app.ruk-com.cloud/books/${book.id}`)
            .then((resp) => {
                if (resp.status == 200) {
